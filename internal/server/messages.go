...
var messageMap = map[string]map[string]string{
	...
	"file_too_large":          {"en": "Uploaded file exceeds the configured size limit", "zh": "上传文件超过配置的大小限制"},
	...
	"site_size_limit":         {"en": "Upload canceled: merged site files would exceed the configured size limit", "zh": "上传已取消：合并后的站点文件将超过配置的总大小限制"},
	"clear_files_failed":      {"en": "Failed to clear site files", "zh": "清空站点文件失败"},
	"download_files_failed":   {"en": "Failed to package site files", "zh": "打包站点文件失败"},
	"site_files_empty":        {"en": "The site has no files to download", "zh": "站点目录为空，无法下载"},
