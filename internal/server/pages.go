...
.modal p{font-size:.85rem;color:var(--dim);margin-bottom:1rem}
.modal .modal-actions{display:flex;gap:.5rem;justify-content:flex-end;margin-top:1rem}
@media(max-width:640px){.navbar{padding:0 .75rem}.stats-grid{grid-template-columns:1fr}.lang-toggle a{padding:2px 5px;font-size:.7rem}.admin-layout{grid-template-columns:1fr!important}.admin-sidebar{position:static!important;flex-direction:row;overflow-x:auto;height:auto!important}.admin-nav-item{white-space:nowrap}.admin-main{padding:0!important}}
@media(prefers-reduced-motion:reduce){*{transition:none!important}}
