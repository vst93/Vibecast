...
xhr.onerror=function(){if(btn){btn.firstChild.textContent=origText;btn.style.opacity="";btn.style.pointerEvents=""}toast(t("networkError"),"error")};
xhr.send(fd);
}
function delSite(id){
...
.modal .modal-actions{display:flex;gap:.5rem;justify-content:flex-end;margin-top:1rem}
.pwd-wrap{position:relative;display:flex;align-items:center}.pwd-wrap input{width:100%;padding-right:38px!important;box-sizing:border-box}.pwd-toggle{position:absolute;right:8px;top:50%;transform:translateY(-50%);background:none;border:none;cursor:pointer;display:flex;align-items:center;justify-content:center;width:28px;height:28px;border-radius:5px;color:var(--dim);padding:0;transition:color .15s,background .15s}.pwd-toggle:hover{color:var(--text);background:var(--surface-2)}.pwd-toggle svg{width:16px;height:16px;flex-shrink:0}
@media(max-width:640px){.navbar{padding:0 .5rem;height:48px}.navbar .logo{font-size:.85rem}.navbar .nav-right{gap:.4rem}.stats-grid{grid-template-columns:1fr}.lang-toggle a{padding:2px 5px;font-size:.7rem}.admin-layout{grid-template-columns:1fr!important;min-height:auto!important}.admin-sidebar{position:fixed!important;bottom:0;left:0;right:0;top:auto!important;flex-direction:row;overflow-x:auto;height:52px!important;border-right:none;border-top:1px solid var(--line);padding:0;z-index:100;background:var(--surface);justify-content:flex-start}.admin-nav-item{white-space:nowrap;padding:.5rem .65rem;font-size:.7rem;flex-direction:column;gap:.15rem;border-left:none;border-bottom:2px solid transparent}.admin-nav-item.active{border-left:none;border-bottom-color:var(--accent)}.admin-nav-item span{display:inline}.admin-nav-item svg{width:16px;height:16px}.admin-main{padding:.75rem!important;padding-bottom:70px!important}.container{padding:0 .75rem;margin-top:1rem}.modal{max-width:calc(100vw - 2rem);padding:1.2rem}.toast{bottom:60px;right:1rem;left:1rem;text-align:center}table{font-size:.7rem}th,td{padding:.3rem .4rem}.info-grid{grid-template-columns:1fr}}
@media(prefers-reduced-motion:reduce){*{transition:none!important}}
