...
.num-setting{display:flex;align-items:center;justify-content:space-between;padding:.6rem 0;border-bottom:1px solid var(--line)}.num-setting:last-child{border-bottom:none}.num-setting .num-info{flex:1}.num-setting .num-label{font-size:.85rem;font-weight:500}.num-setting .num-desc{font-size:.7rem;color:var(--dim);margin-top:.1rem}.num-setting .num-control{display:flex;align-items:center;gap:.4rem;flex-shrink:0}.num-setting .num-control input{width:72px;padding:6px 8px;border:1px solid var(--line);border-radius:5px;font-size:.85rem;background:var(--ink);color:var(--text);text-align:center;outline:none;transition:border-color .15s;font-family:var(--mono)}.num-setting .num-control input:focus{border-color:var(--accent)}.num-setting .num-control .unit{font-size:.75rem;color:var(--dim);font-family:var(--mono);white-space:nowrap}
