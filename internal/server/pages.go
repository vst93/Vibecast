...
var editSiteId=0;
function openEditSiteModal(id,name,desc){
editSiteId=id;document.getElementById("edit-site-name").value=name;document.getElementById("edit-site-desc").value=desc;
